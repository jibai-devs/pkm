...
struct PlayerState {
  ...
  void clearActiveState() { activeState = 0; }

  bool isPoisoned() const { return poisonDamageCounter > 0; }

  void clearPoison() { poisonDamageCounter = 0; }

  bool isBurned() const { return burned; }
  ...
  CardRef getActive() const { return active.at(0); }
