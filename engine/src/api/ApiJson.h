...
inline void SelectOptionJson(JsonBuilder &j, const SelectOption &option,
                             bool web) {
  j.append('{');
  j.appendKey("type");
  if (!web) {
    j.append(static_cast<int>(option.type));
  }
  switch (option.type) {
...
inline void LogJson(JsonBuilder &j, const Log &log, int playerIndex, bool web) {
  ...
  case LogType::Shuffle:
    if (web) {
      ...
      j.append(static_cast<int>(log.logType));
    }
  ...
  case LogType::HasBasicPokemon:
    ...
    j.appendCommaKeyValue("playerIndex", log.param[0]);
    j.appendCommaKeyValue("hasBasicPokemon", static_cast<bool>(log.param[1]));
    break;
  ...
  case LogType::Draw:
    if (log.param[0] == playerIndex || playerIndex == 2) {
      ...
      if (web) {
        ...
        j.append(static_cast<int>(LogType::DrawReverse));
      }
      j.appendCommaKeyValue("playerIndex", log.param[0]);
    }
    break;
  ...
  case LogType::MoveCard:
    if (log.param[5] == 0 ||
        (log.param[5] == 1 && log.param[0] == playerIndex) ||
        (log.param[5] == 3 && playerIndex == 0) ||
        (log.param[5] == 4 && playerIndex == 1) || playerIndex == 2) {
      if (web) {
      ...
      if (web) {
        ...
        j.append(static_cast<int>(LogType::MoveCardReverse));
      }
      j.appendCommaKeyValue("playerIndex", log.param[0]);
      j.appendCommaKeyValue("fromArea", log.param[3]);
      j.appendCommaKeyValue("toArea", log.param[4]);
  ...
  case LogType::HpChange:
    ...
    j.appendCommaKeyValue("putDamageCounter", static_cast<bool>(log.param[4]));
    break;
  case LogType::Poisoned:
    ...
    j.appendCommaKeyValue("playerIndex", log.param[0]);
    j.appendCommaKeyValue("isRecover", static_cast<bool>(log.param[1]));
  ...
  case LogType::Coin:
    ...
    j.appendCommaKeyValue("playerIndex", log.param[0]);
    j.appendCommaKeyValue("head", static_cast<bool>(log.param[1]));
    break;
  case LogType::Result:
    if (web) {
