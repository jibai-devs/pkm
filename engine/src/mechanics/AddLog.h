...
inline void LogHasBasicPokemon(State &state, int playerIndex,
                               bool hasBasicPokemon) {
  if (state.isAddLog()) {
...
inline void LogMoveCard(State &state, int playerIndex, CardRef ref,
                        AreaType fromArea, AreaType toArea, int openType) {
  if (state.isAddLog()) {
...
inline void LogMoveCardReverse(State &state, int playerIndex, AreaType fromArea,
                               AreaType toArea) {
  if (state.isAddLog()) {
...
inline void LogSwitch(State &state, int playerIndex, CardRef refActive,
                      CardRef refBench) {
  if (state.isAddLog()) {
...
inline void LogChange(State &state, int playerIndex, CardRef refBefore,
                      CardRef refAfter) {
  if (state.isAddLog()) {
...
inline void LogAttach(State &state, int playerIndex, CardRef ref,
                      CardRef refTarget) {
  if (state.isAddLog()) {
...
inline void LogEvolve(State &state, int playerIndex, CardRef ref,
                      CardRef refTarget) {
  if (state.isAddLog()) {
...
inline void LogDevolve(State &state, int playerIndex, CardRef ref,
                       CardRef refTarget) {
  if (state.isAddLog()) {
...
inline void LogMoveAttached(State &state, int playerIndex, CardRef ref,
                            CardRef refBefore, CardRef refAfter) {
  if (state.isAddLog()) {
...
inline void LogAttack(State &state, int playerIndex, CardRef ref,
                      int attackId) {
  if (state.isAddLog()) {
...
inline void LogHpChange(State &state, int playerIndex, CardRef ref, int value,
                        bool putDamageCounter) {
  if (state.isAddLog()) {
...
inline void LogPoisoned(State &state, int playerIndex, bool isRecover,
                        CardRef ref) {
  if (state.isAddLog()) {
...
inline void LogBurned(State &state, int playerIndex, bool isRecover,
                      CardRef ref) {
  if (state.isAddLog()) {
...
inline void LogAsleep(State &state, int playerIndex, bool isRecover,
                      CardRef ref) {
  if (state.isAddLog()) {
...
inline void LogParalyzed(State &state, int playerIndex, bool isRecover,
                         CardRef ref) {
  if (state.isAddLog()) {
...
inline void LogConfused(State &state, int playerIndex, bool isRecover,
                        CardRef ref) {
  if (state.isAddLog()) {
