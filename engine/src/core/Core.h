...
constexpr int MAX_CARD_COUNT = 128;

constexpr int PLAYER_COUNT = 2;
constexpr int INITIAL_MOVE_COUNTER = 1;
constexpr signed char NO_FIRST_PLAYER = -1;
constexpr int DRAW_PLAYER_INDEX = 2;
constexpr int MAX_ACTION_COUNT = 3000;
